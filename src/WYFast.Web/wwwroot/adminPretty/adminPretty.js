...
var tablist = {
    newTab: function(n) {
        ...
        $(".menuTab").each(function() {
            if ($(this).data("id") == t) return $(this).hasClass("active") || ($(this).addClass("active").siblings(".menuTab").removeClass("active"), $.tab.scrollToTab(this), $("#mainContent .LRADMS_iframe").each(function() {
    ...
    n.tab = {
        ...
        activeTab: function() {
            ...
            n(this).hasClass("active") || (n("#mainContent .LRADMS_iframe").each(function() {
                ...
                !1
            }), n(this).addClass("active").siblings(".menuTab").removeClass("active"), n.tab.scrollToTab(this));
        ...
        closeTab: function() {
            ...
            "fast"), n(this).parents(".menuTab").remove(), n("#mainContent .LRADMS_iframe").each(function() {
                ...
                if (n(this).data("id") == i) return n(this).remove(),
                !1
            }), n.tab.scrollToTab(n(".menuTab.active"))),
        ...
        addTab: function() {
            ...
            return (i != "" && top.$.cookie("currentmoduleId", i, {
                ...
                if (n(this).data("id") == t) return n(this).hasClass("active") || (n(this).addClass("active").siblings(".menuTab").removeClass("active"), n.tab.scrollToTab(this), n("#mainContent .LRADMS_iframe").each(function() {
                    if (n(this).data("id") == t) return n(this).show().siblings(".LRADMS_iframe").hide(),
                    !1
                })),
                r = !1,
                !1
            }), r && (f = '<a href="javascript:;" class="active menuTab" data-value=' + i + ' data-id="' + t + '">' + u + '<div class="tab_close "><\/div><\/a>', n(".menuTab").removeClass("active"), e = '<iframe class="LRADMS_iframe" id="iframe' + i + '" name="iframe' + i + '"  width="100%" height="100%" src="' + t + '" frameborder="0" data-id="' + t + '" seamless><\/iframe>', n("#mainContent").find("iframe.LRADMS_iframe").hide(), n("#mainContent").append(e), .loading({
                isShow: !0
            }), n("#mainContent iframe:visible").load(function() {
                .loading({
                    isShow: !1
                })
            }), n(".menuTabs .page-tabs-content").append(f), n.tab.scrollToTab(n(".menuTab.active"))), n(this).parents(".popover-moreMenu").hide(), n(this).parents(".popover-menu").hide(), n(this).parents(".popover-menu-sub").hide(), !1)
        },
        scrollTabRight: function() {
            var f = Math.abs(parseInt(n(".page-tabs-content").css("margin-left"))),
            e = n.tab.calSumWidth(n(".lea-tabs").children().not(".menuTabs")),
            ...
            t = n(t).next();
            r = n.tab.calSumWidth(n(t).prevAll());
        ...
        scrollTabLeft: function() {
            ...
            for (t = n(".menuTab:first"), i = 0; i + n(t).outerWidth(!0) <= f;) i += n(t).outerWidth(!0),
            t = n(t).next();
            if (i = 0, n.tab.calSumWidth(n(t).prevAll()) > r) {
                while (i + n(t).outerWidth(!0) < r && t.length > 0) i += n(t).outerWidth(!0),
                t = n(t).prev();
                u = n.tab.calSumWidth(n(t).prevAll())
            }
        ...
        scrollToTab: function(t) {
            var f = n.tab.calSumWidth(n(t).prevAll()),
            e = n.tab.calSumWidth(n(t).nextAll()),
            o = n.tab.calSumWidth(n(".lea-tabs").children().not(".menuTabs")),
        ...
        init: function() {
            n(".menuTabs").on("click", ".menuTab .tab_close", n.tab.closeTab);
            n(".menuTabs").on("click", ".menuTab", n.tab.activeTab);
            n(".tabLeft").on("click", n.tab.scrollTabLeft);
            n(".tabRight").on("click", n.tab.scrollTabRight);
            n(".tabReload").on("click", n.tab.refreshTab);
            ...
            n(".tabCloseOther").on("click", n.tab.closeOtherTabs);
            n(".fullscreen").on("click",
            function() {
                n(this).attr("fullscreen") ? (n(this).removeAttr("fullscreen"), n.tab.exitFullscreen()) : (n(this).attr("fullscreen", "true"), n.tab.requestFullScreen())
            })
        }
    };
    n.index = {
        ...
        loadMenu: function(t) {
            var e = !1,
            o = n(".lea-Head").width() - n.tab.calSumWidth(n(".lea-Head").children().not(".left-bar")),
            i = top..data.get(["authorizeMenu"]),
            r = "",
            u = 0,
            s = "",
            f = "";
            ...
            function(t) {
                ...
                e,
                c;
                h.F_ParentId == "0" && (e = "", e += '<li class="treeview">', e += "<a>", e += '<i class="' + h.F_Icon + '"><\/i><span>' + h.F_FullName + "<\/span>", e += "<\/a>", c = n.index.jsonWhere(i,
                function(n) {
                ...
                n(".menuiframe").unbind();
                n(".menuiframe").on("click", n.tab.addTab);
