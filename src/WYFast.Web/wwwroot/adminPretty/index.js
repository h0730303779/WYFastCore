...
(function ($) {
    ...
    $.tab = {
        ...
        scrollTabRight: function () {
            ...
            var tabOuterWidth = $.tab.calSumWidth($(".lea-tabs").children().not(".menuTabs"));
        ...
        init: function () {
            $('.menuTabs').on('click', '.menuTab .tab_close', $.tab.closeTab);
    ...
    $.index = {
        ...
        loadMenu: function (isInit) {
            var flag = false;
            var topMenuWidth = $('.lea-Head').width() - $.tab.calSumWidth($(".lea-Head").children().not(".left-bar"));
            ...
            if (isInit || flag) {
                ...
                $('.menuiframe').unbind();
                $('.menuiframe').on('click', $.tab.addTab);
